...
const COMPARE_ROWS: Array<{ name: string; cells: Array<CompareCell> }> = [
  { name: 'Seedance 2.5', cells: [{ p: '160' }, { s: '160', p: '128' }, { s: '160', p: '128' }, { s: '160', p: '112' }, { s: '160', p: '80' }, { s: '160', p: '64' }, { p: '160' }, { p: '160' }] },
  ...
  { name: 'Kling 2.1 Master', cells: ['X', { s: '200', p: '160' }, { s: '200', p: '160' }, { s: '200', p: '140' }, { s: '200', p: '100' }, { s: '200', p: '80' }, 'X', { p: '200' }] },
  ...
  { name: 'Nano Banana Pro', cells: ['X', { s: '40', p: '4' }, { p: '40' }, { s: '40', p: '4' }, { p: '免费' }, { p: '免费' }, 'X', { p: '40' }] },
